...
> 🔄 **STATUS 2026-04-16: EM REVISÃO — AMPLIAÇÃO EM CURSO.** O escopo atual (laboratório de bancada) está correto mas **incompleto**: operação de campo com UMC, veículos operacionais, CRM offline do vendedor, despesa por OS e offline-first sistêmico **faltavam**. O escopo está sendo **ampliado** (não substituído) — bancada continua dentro, campo entra junto. A linha 78 ("app mobile nativo fica fora") será revisada para refletir PWA + Capacitor como default, não como exceção. Ver [`docs/incidents/discovery-gap-offline-2026-04-16.md`](../incidents/discovery-gap-offline-2026-04-16.md).
